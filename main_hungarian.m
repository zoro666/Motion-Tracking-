...
for currframe = startframe:endframe
    ...
    [observ_labeled,score] = hungarian( observed,statemeans,statecovmats);
...
save 'corrected_marker_labels_hungarian.mat' outputc3d
...
plot(score_tb)
title('scores by hungarian data association')
xlabel('frames')
ylabel('scores')
